...
# Ramdisk
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/rootdir/ueventd.sprout.rc:$(TARGET_COPY_OUT_ROOT)/ueventd.sprout.rc \
    $(LOCAL_PATH)/rootdir/init.sprout.usb.rc:$(TARGET_COPY_OUT_ROOT)/init.sprout.usb.rc \
    $(LOCAL_PATH)/rootdir/init.sprout.rc:$(TARGET_COPY_OUT_ROOT)/init.sprout.rc \
    $(LOCAL_PATH)/rootdir/fstab.sprout:$(TARGET_COPY_OUT_ROOT)/fstab.sprout
